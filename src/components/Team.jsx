...
const Team = () => {
  ...
  return (
    <section id="services" className="team snap">
        ...
        <div className="services-section">
          <p className="services-description">
            ...
            <span style={{ color: '#ffffffff' }}>
              <strong>Short Films</strong> | <strong>Documentaries</strong> | <strong>TV Commercials</strong> | <strong>Projects and Products</strong>
